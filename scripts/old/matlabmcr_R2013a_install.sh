...
downloaduri=http://www.mathworks.com/supportfiles/MCR_Runtime/R2013a/MCR_R2013a_glnxa64_installer.zip
tempinstalldir=${tarinstalldir}/tmp_install
tarfilename=MCR_R2013a_glnxa64_installer.zip
...
cd ${tempinstalldir} 
echo "
destinationFolder= ${installprefix}
agreeToLicense=yes
mode=silent
" > matlab_install_params.txt
./install -inputFile ./matlab_install_params.txt
