...
# rstudio-desktop relies on the PAM headers and libraries from the debian package libpam0g-dev
...
conflict RSTUDIO_DESKTOP_CHOICE

use -e -r boost-1.62.0

desc "RStudio Desktop ${VERSION}"

help "RStudio Desktop is a free and open source integrated development environment for R for the web."
