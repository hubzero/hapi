...
installscript=Anaconda3-2020.11-Linux-x86_64.sh
if [ ! -f ${basedir}/${pkgname}/${installscript} ]; then
    # From https://www.anaconda.com/products/individual#Downloads
    wget https://help.hubzero.org/app/site/addons/tools/${installscript} -O ${basedir}/${pkgname}/${installscript}
    chown apps:apps ${basedir}/${pkgname}/${installscript}
    chmod 755 ${basedir}/${pkgname}/${installscript}
fi
...
./jupyter_notebook_setup/jpkg --with-r --with-dash --envdir=${environdir} install ${VERSION}
