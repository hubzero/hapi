...
# not sure where pandoc came from
#
#pandocdir=$(find /apps/share64/debian7 -name "pandoc" -type d)
#
#if [[ -d ${pandocdir} ]] ; then
#    pandocpath=:${pandocdir}
#else
#    pandocpath=""
#fi

#prepend PATH \${location}/bin${pandocpath}
...
${installdir}/r-3.2.5-packages_install.sh
